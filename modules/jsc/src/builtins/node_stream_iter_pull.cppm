// node:stream/iter payload partition — pull()/pullSync()/pipeTo()/pipeToSync() pipelines
//
// Mechanical 1:1 translation of bun-ref src/js/internal/streams/iter/{pull}.ts
...
export module mbun.jsc.js_builtins:node_stream_iter_pull;

import std;

export namespace mbun::jsc::builtins::detail {

inline constexpr std::string_view kNodeStreamIterPullJS = R"JS(
(function () {
  const G = globalThis;
  ...
  R.def("internal/streams/iter/pull", function (require, module, exports) {

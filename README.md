...
| Node.js native tests (`compat/node/test/parallel`) | 2,120 / 4,433 files pass (direct execution) | 47.8% |
| Node.js native tests, excluding files that skip themselves | 2,120 / 3,887 files pass | 54.5% |

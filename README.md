...
| Node.js native tests (`compat/node/test/parallel`) | 2,403 / 4,433 files pass (direct execution) | 54.2% |
| Node.js native tests, excluding files that skip themselves | 2,403 / 3,878 files pass | 62.0% |

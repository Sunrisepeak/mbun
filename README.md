...
| Node.js native tests (`compat/node/test/parallel`) | 2,566 / 4,433 files pass (direct execution) | 57.9% |
| Node.js native tests, excluding files that skip themselves | 2,566 / 3,881 files pass | 66.1% |

...
| Node.js native tests (`compat/node/test/parallel`) | 2,369 / 4,433 files pass (direct execution) | 53.4% |
| Node.js native tests, excluding files that skip themselves | 2,369 / 3,878 files pass | 61.1% |

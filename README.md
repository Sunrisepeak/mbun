...
| Node.js native tests (`compat/node/test/parallel`) | 2,459 / 4,433 files pass (direct execution) | 55.5% |
| Node.js native tests, excluding files that skip themselves | 2,459 / 3,878 files pass | 63.4% |
